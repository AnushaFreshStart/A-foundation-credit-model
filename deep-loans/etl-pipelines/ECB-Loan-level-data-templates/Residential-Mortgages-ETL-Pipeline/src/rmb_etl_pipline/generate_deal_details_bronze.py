...
from src.rmb_etl_pipeline.utils.bronze_funcs import perform_scd2
from delta import *
...
def get_raw_file(bucket_name, prefix, file_key):
    """
    Return list of XML files that satisfy the file_key parameter from the Securitisation Repository.
