...
with models.DAG(
    "rmb_deal_details",  # The id you will see in the DAG airflow page
                ...
                batch={
                    "pyspark_batch": {
                        ...
                        "args": [
                            ...
                            "--target-prefix=RMB/bronze/deal_details",
                ...
                batch={
                    "pyspark_batch": {
                        ...
                        "args": [
                            ...
                            f"--raw-bucketname={RAW_BUCKET}",
                            f"--data-bucketname={DATA_BUCKET}",
                            "--source-prefix=RMB/bronze/deal_details",
                            "--target-prefix=RMB/silver/deal_details",
