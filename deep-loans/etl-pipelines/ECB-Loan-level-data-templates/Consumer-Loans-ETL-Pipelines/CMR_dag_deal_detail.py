...
with models.DAG(
    "cmr_deal_details",  # The id you will see in the DAG airflow page
                ...
                batch={
                    "pyspark_batch": {
                        ...
                        "args": [
                            ...
                            "--target-prefix=CMR/bronze/deal_details",
                ...
                batch={
                    "pyspark_batch": {
                        ...
                        "args": [
                            ...
                            f"--raw-bucketname={RAW_BUCKET}",
                            f"--data-bucketname={DATA_BUCKET}",
                            "--source-prefix=CMR/bronze/deal_details",
                            "--target-prefix=CMR/silver/deal_details",
                            f"--dl-code={dl_code}",
