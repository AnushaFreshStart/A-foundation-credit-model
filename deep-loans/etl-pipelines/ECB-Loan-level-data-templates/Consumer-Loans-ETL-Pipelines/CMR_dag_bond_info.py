...
PYTHON_FILE_LOCATION = f"gs://{CODE_BUCKET}/dist/cmr_main.py"
...
PY_FILES = f"gs://{CODE_BUCKET}/dist/cmr_etl_pipeline_0.1.0.zip"
...
RUNTIME_CONFIG = {
    "properties": {
        "spark.app.name": "cmr_etl_pipeline",
        ...
        set(
            [
                ...
                for b in storage_client.list_blobs(
                    bucket.name,
                    prefix="dl_data/downloaded-data/CMR",
                )
...
# PROFILE + BRONZE
with models.DAG(
    "cmr_bond_info",  # The id you will see in the DAG airflow page
                ...
                batch={
                    "pyspark_batch": {
                        ...
                        "args": [
                            ...
                            f"--source-prefix=dl_data/downloaded-data/CMR/{dl_code}",
                            "--file-key=Bond_Info",
                ...
                batch={
                    "pyspark_batch": {
                        ...
                        "args": [
                            ...
                            f"--data-bucketname={DATA_BUCKET}",
                            f"--source-prefix=dl_data/downloaded-data/CMR/{dl_code}",
                            "--target-prefix=CMR/bronze/bond_info",
...
#                         f"--raw-bucketname={RAW_BUCKET}",
#                         f"--data-bucketname={DATA_BUCKET}",
#                         "--source-prefix=CMR/bronze/bond_info",
#                         "--target-prefix=CMR/silver/bond_info",
#                         f"--dl-code={dl_code}",
