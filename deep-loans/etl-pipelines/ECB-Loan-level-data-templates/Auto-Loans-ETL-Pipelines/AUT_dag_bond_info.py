...
# PROFILE + BRONZE
with models.DAG(
    "aut_bond_info",  # The id you will see in the DAG airflow page
                ...
                batch={
                    "pyspark_batch": {
                        ...
                        "args": [
                            ...
                            f"--data-bucketname={DATA_BUCKET}",
                            f"--source-prefix=dl_data/downloaded-data/AUT/{dl_code}",
                            "--target-prefix=AUT/bronze/bond_info",
...
#                         f"--raw-bucketname={RAW_BUCKET}",
#                         f"--data-bucketname={DATA_BUCKET}",
#                         "--source-prefix=AUT/bronze/bond_info",
#                         "--target-prefix=AUT/silver/bond_info",
#                         f"--dl-code={dl_code}",
