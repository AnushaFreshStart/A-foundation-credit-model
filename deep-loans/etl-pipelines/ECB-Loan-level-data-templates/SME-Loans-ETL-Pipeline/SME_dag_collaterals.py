...
with models.DAG(
    ...
    for rp in raw_prefixes:
        ...
        with TaskGroup(group_id=f"{dl_code}_collaterals") as tg:
            profile_task = DataprocCreateBatchOperator(
                ...
                batch_id=f"{dl_code.lower()}-collaterals-profile",
            )
            bronze_task = DataprocCreateBatchOperator(
                ...
                batch_id=f"{dl_code.lower()}-collaterals-bronze",
            )
...
#                 "runtime_config": RUNTIME_CONFIG,
#             },
#             batch_id=f"{dl_code.lower()}-collaterals-silver",
#         )
