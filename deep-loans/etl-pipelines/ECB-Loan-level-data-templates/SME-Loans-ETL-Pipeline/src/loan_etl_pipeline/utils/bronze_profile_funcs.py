...
def _correct_file_coding(raw_file_obj):
    """
    Check that the content of the CSV does not contain conding issues from Sec Rep.
...
def get_csv_files(bucket_name, prefix, file_key, data_type):
    """
    Return list of source files that satisfy the file_key parameter from Sec Rep.
