"""
run_manager.py — Multi-Run Save/Load/Compare for Training Experiments
=======================================================================
...
class RunManager:
    ...
    def save_run(
        ...
        if checkpoint:
            ...
            print(f"  OK Checkpoint → {ckpt_path.name} ({size_mb:.1f} MB)")
        ...
        if embed_src.exists():
            ...
            print(f"  OK Embeddings → {run_id}/embeddings.parquet")
